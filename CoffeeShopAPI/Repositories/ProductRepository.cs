...
namespace CoffeeShopAPI.Repositories
{
    public class ProductRepository : Repository<Product>, IProductRepository
    {
        ...
        public override Product GetById(int Id) => _dbSet.Include(p => p.Sizes).First(p => p.Id == Id);
        public async override Task<Product> GetByIdAsync(int Id) => await _dbSet.Include(p => p.Sizes).FirstAsync(p => p.Id == Id);
